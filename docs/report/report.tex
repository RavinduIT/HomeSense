...
\midrule
Application unit tests & 75 & Grid mapping, wire format, repository propagation and session teardown, Room aggregation, CSV escaping, schedule windows \\
...
A2  & Household tenancy and roles & \code{database.rules.json} & Table 
ef{tab:rulescheck} & --- \
